                ...
                <div class="col-md-6">
                    <div class="card p-3">
                        ...
                        <form method="post" action="warehouseservlet">
                            <input type="hidden" name="id" value="<%= request.getAttribute("warehouseToEdit") != null ? ((Warehouse) request.getAttribute("warehouseToEdit")).getId() : "" %>">

                            <div class="mb-3">
                                <label class="form-label">Warehouse Name</label>
                                <input type="text" class="form-control" name="name" required 
                                       value="<%= request.getAttribute("warehouseToEdit") != null ? ((Warehouse) request.getAttribute("warehouseToEdit")).getName() : "" %>">
                            </div>

                            <div class="mb-3">
                                <label class="form-label">Location</label>
                                <input type="text" class="form-control" name="location" required 
                                       value="<%= request.getAttribute("warehouseToEdit") != null ? ((Warehouse) request.getAttribute("warehouseToEdit")).getLocation() : "" %>">
                            </div>
